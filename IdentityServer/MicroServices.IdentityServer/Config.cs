                            ...
                            new ApiScope("discount_fullpermission","Discount API için full erişim"),
                                new ApiScope("order_fullpermission","Order API için full erişim"),
                                    new ApiScope("payment_fullpermission","Payment API için full erişim"),
                                        new ApiScope("getaway_fullpermission","Getaway API için full erişim"),
        ...
        public static IEnumerable<Client> Clients =>
            new Client[]
            {
                ...
                new Client
                {
                    ...
                    AllowedScopes = { "category_fullpermission", "basket_fullpermission", "order_fullpermission", "discount_fullpermission", "cargo_fullpermission", "payment_fullpermission",
